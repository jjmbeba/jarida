...
const VideoEmbed = ({ embed, focused, isYoutube, provider, selected }: {
  embed: { id?: string; url?: string } | undefined;
  focused: boolean;
  isYoutube: boolean;
...
export const MediaEmbedElement = withHOC(
  ResizableProvider,
  function MediaEmbedNode(props: PlateElementProps<TMediaEmbedElement>) {
    const {
      align = 'center',
      embed,
      focused,
