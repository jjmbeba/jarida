...
export const ColumnElement = withHOC(
  ResizableProvider,
  function ColumnNode(props: PlateElementProps<TColumnElement>) {
...
const ColumnDragHandle = memo(function ColumnDragHandler() {
  return (
    <TooltipProvider>
      <Tooltip>
...
const RightSideDoubleColumnOutlined = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <title>Right side double column layout</title>
    <path
      clipRule="evenodd"
...
const LeftSideDoubleColumnOutlined = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <title>Left side double column layout</title>
    <path
      clipRule="evenodd"
...
const DoubleSideDoubleColumnOutlined = (props: LucideProps) => (
  <svg
    ...
    {...props}
  >
    <title>Double side double column layout</title>
    <path
      clipRule="evenodd"
